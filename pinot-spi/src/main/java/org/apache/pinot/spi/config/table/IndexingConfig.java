...
public class IndexingConfig extends BaseJsonConfig {
  ...
  /**
   * Similar to `optimizeDictionary`, except it works in the reverse direction. Raw encoded columns can be dictionary
   * encoded if the estimated cardinality is small
   */
