...
public class CachingMutableOffHeapByteArrayStoreV2Test {
  ...
  public void testFlow()
    ...
    CachingMutableOffHeapByteArrayStoreV2 store =
        new CachingMutableOffHeapByteArrayStoreV2(_memoryManager, "stringColumn", numArrays, avgArrayLen, cacheSize);
