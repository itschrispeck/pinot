...
public class CachingMutableOffHeapByteArrayStoreTest {
  ...
  public void testFlow()
    ...
    int numArrays = 1024;
    int avgArrayLen = 32;
    CachingMutableOffHeapByteArrayStore store =
        new CachingMutableOffHeapByteArrayStore(_memoryManager, "stringColumn", numArrays, avgArrayLen);
