...
public class MutableCachingOffHeapByteArrayStoreTest {
  ...
  public void testFlow()
    ...
    int numArrays = 1024;
    int avgArrayLen = 32;
    MutableCachingOffHeapByteArrayStore store =
        new MutableCachingOffHeapByteArrayStore(_memoryManager, "stringColumn", numArrays, avgArrayLen);
