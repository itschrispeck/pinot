...
public class StringOffHeapMutableDictionary extends BaseOffHeapMutableDictionary {
  private final CachingMutableOffHeapByteArrayStore _byteStore;
  ...
  public StringOffHeapMutableDictionary(int estimatedCardinality, int maxOverflowHashSize,
    ...
    _byteStore =
        new CachingMutableOffHeapByteArrayStore(memoryManager, allocationContext, estimatedCardinality, avgStringLen);
  }
